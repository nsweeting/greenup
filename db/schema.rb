...
ActiveRecord::Schema.define(version: 20170419211456) do
  ...
  create_table "sale_taxes", force: :cascade do |t|
    t.string   "name"
    t.decimal  "percent",    precision: 2, default: 0
    t.integer  "account_id",                           null: false
    t.datetime "created_at",                           null: false
    t.datetime "updated_at",                           null: false
    t.index ["account_id"], name: "index_sale_taxes_on_account_id", using: :btree
  end
